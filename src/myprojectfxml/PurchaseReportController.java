 ...
 Alert erralert = new Alert(Alert.AlertType.ERROR);
    ...
    private void searchReport(ActionEvent event) 
    {
        try
        {
           ...
           myconn=(com.mysql.jdbc.Connection) DriverManager.getConnection(path+place, user, pass);
            try
            {
               String q="select * from purchase where billdate between ? and ?";
               ...
               if(res.next())
               {
                  do
                  {
                      ...
                      String supp = res.getString("supid");
               ...
               {
                   infoalert.setTitle("Purchase Report ");
    ...
    private void opensupplierReport(String x) 
    {
     try {
         ...
         FXMLLoader myloader=new FXMLLoader(getClass().getResource("SupplierReport.fxml"));
         Parent root = myloader.load();
         SupplierReportController fcontroller=(SupplierReportController)myloader.getController();
         fcontroller.getpurchId(x);
