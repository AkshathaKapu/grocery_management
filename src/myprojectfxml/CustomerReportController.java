...
public class CustomerReportController  implements Initializable {
 ...
 @FXML
    ...
    void getsellId(String x) {
        fetchselldetail(x);
    }
     void fetchselldetail(String pid)
{
    try 
        {
           ...
           try
           {
               ...
               String qry="select * from selldetail where sellid = ?";
...
//                DefaultTableModel model=(DefaultTableModel) jTable1.getModel();
                ...
                purIdBox.setText(pid);
                 if(result.next())
                 {
                     suppnamebox.setText(result.getString("custname"));
                     do
                     {
           ...
           {
                 erralert.setTitle("Customer Report");
